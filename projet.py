...
# ────────────────────────────────────────────────
    ...
    fig1 = px.scatter(
        ...
        labels={
            "Jeux publiés": "Nombre de jeux publiés ",
...
""")
    ...
    "et des titres à fort potentiel multijoueur (*The Mighty Quest for Epic Loot, Trackmania mais surtout Brawlhalla*.)."
)
    ...
    if not g.empty:
        ...
        apply_light_theme(fig5, title_text="Évolution des unités vendues/téléchargées : Jeux gratuits vs payants",
                          x_title="Année", y1_title="Unités vendues/téléchargées (millions)")
